...
public class MoneyTransferServiceFailsOnLowBalanceTest extends AbstractSpringTest {
...
//		try {
			//set up SUT
			when(mockedAccountService.verifyBalance(lowBalancedAccount)).thenReturn(false);
...
//			e.printStackTrace();
//			assertEquals(MoneyTransferServiceBean.LOW_BALANCE_ERROR_MESSAGE, e.getMessage());
//		}
	}
}
